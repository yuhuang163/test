...
// [CAMERA_VER] 设置每次打开上位机都显示tab的第一页，增加对q30的适配，以及配网反初始化，测试完成重启手柄，wifi在总设置里面配置，测试的时候会自动加载wifi设备名字密码ip端口，不用重启上位机
...
// [FREE_VER] 仪器流程六连停止接收与PER，非信令步 id 顺延
...
// [FREE_VER] MES 电量项拆 BATTERY_INFO 与 BATTERY_PERCENT，testData 仅数值
