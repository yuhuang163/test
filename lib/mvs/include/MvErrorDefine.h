...
#define MV_E_LIQUIDLENS_DATA_FORMAT_ERROR           0x80000606  ///< \~chinese Data字段格式错误         \~english Data field format error
...
#define MV_E_LIQUIDLENS_AF_IMAGE_ABNORMAL           0x80000633  ///< \~chinese 对焦时图像异常,比如画面全黑全白等   \~english Image abnormal during focusing, such as completely black or white
...
#define MV_E_LIQUIDLENS_AF_ROI_INVALID              0x80000640  ///< \~chinese 自动对焦时，ROI参数无效（坐标越界或宽高异常） \~english ROI parameter is invalid during auto focus (out of bounds or invalid size)
#define MV_E_LIQUIDLENS_AF_FOCAL_POWER_RANGE        0x80000641  ///< \~chinese 自动对焦时，焦距功率范围过小（差值需大于20） \~english Focal power range is too small during auto focus (difference must be greater than 20)
