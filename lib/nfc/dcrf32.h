...
extern "C" {
   ...
   * @n 0x00 - 全部不配置。
   * @n 0x01 - 配置 ::rf_gain 有效。
   * @n 0x02 - 配置 ::minimum_power 有效。
   * @n 0x04 - 配置 ::couple_power 有效。
   * @n 0x08 - 配置 ::modulation_depth 有效。
   * @n 0x10 - 配置 ::waveform_adjustment 有效。
   * @n 0x20 - 配置 ::rf_strength 有效。
