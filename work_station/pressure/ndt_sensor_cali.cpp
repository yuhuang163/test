...
void ndt_sensor_cali::Sensor_cali_Init(CAL_CHANNEL_E machine)  // 根据不同机型进行初始化
{
    switch (machine) {
        ...
        case CAL_CHANNEL_P30P_CH0:
            ...
            break;
        case CAL_CHANNEL_Y25S_CH0:
            CAL_CHANNEL_NUM = 1;  // 校准通道数
            product = CAL_CHANNEL_Y25S_CH0;
