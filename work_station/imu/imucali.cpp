...
imucali::imucali(int index, QWidget* parent) : test_base(parent), ui(new Ui::imucali), qimuc(new imu_calibrate), nqimuc(new new_imu_calibrate) {
    m_index = index;
