...
static const Row kSettings[] = {
    ...
    LE("lineEdit_factoryCloudBaseUrl", "FactoryCloud/BaseUrl", "http://fctp.luteos.com"),
    LE("lineEdit_factoryCloudUser", "FactoryCloud/AuthUser", nullptr),
    LE("lineEdit_factoryCloudPassword", "FactoryCloud/AuthPassword", nullptr),
    LE("lineEdit_factoryCloudStationKey", "FactoryCloud/StationKey", nullptr),
    CB("checkBox_factoryCloudRememberPassword", "FactoryCloud/RememberPassword", "false"),
    CB("checkBox_factoryCloudLogUpload", "FactoryCloud/Feature/LogUpload", "true"),
    CB("checkBox_factoryCloudThresholdSync", "FactoryCloud/Feature/ThresholdSync", "true"),
    ...
    TIP("lineEdit_factoryCloudBaseUrl", "FactoryCloud/BaseUrl，云端 API 根地址；选「自定义」时可手改。"),
    TIP("comboBox_factoryCloudEnvironment", "FactoryCloud/Environment：测试环境=本机8800，服务器=fctp.luteos.com。"),
    TIP("lineEdit_factoryCloudUser", "FactoryCloud/AuthUser，产线云平台账号。"),
    TIP("lineEdit_factoryCloudPassword", "FactoryCloud/AuthPassword，仅在勾选记住密码时保存。"),
    TIP("lineEdit_factoryCloudStationKey", "FactoryCloud/StationKey，空则使用 TestOrderMeta/SelectedStation。"),
