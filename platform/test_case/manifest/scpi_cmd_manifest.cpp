...
const Row kRows[] = {
    ...
    {ScpiDeviceRoute::HuilingWfp60h, "ConfigureProgrammablePower", u8"配置源通道属性", u8"电压/电流参数", kSet},
    {ScpiDeviceRoute::HuilingWfp60h, "ProgrammablePowerOutput", u8"源通道输出开关", u8"1表示开启，0表示关闭", kSet},
    {ScpiDeviceRoute::HuilingWfp60h, "ReadProgrammableVoltage", u8"读取源电压测量值", nullptr, kGet},
    {ScpiDeviceRoute::HuilingWfp60h, "ReadProgrammableCurrent", u8"读取源电流测量值", nullptr, kGet},
    {ScpiDeviceRoute::HuilingWfp60h, "InitializeProgrammablePower", u8"初始化源通道", nullptr, kGet},
